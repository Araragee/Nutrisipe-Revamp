...
CREATE TABLE "ingredients" (
    ...
    "alt_name" TEXT,
    "category" TEXT,
    "edible_portion" REAL NOT NULL DEFAULT 100,
    "energy" REAL NOT NULL DEFAULT 0,
    "protein" REAL NOT NULL DEFAULT 0,
    "fat" REAL NOT NULL DEFAULT 0,
    "carb" REAL NOT NULL DEFAULT 0,
    "calcium" REAL NOT NULL DEFAULT 0,
    "phos" REAL NOT NULL DEFAULT 0,
    "iron" REAL NOT NULL DEFAULT 0,
    "vit_a" REAL NOT NULL DEFAULT 0,
    "thia" REAL NOT NULL DEFAULT 0,
    "ribo" REAL NOT NULL DEFAULT 0,
    "nia" REAL NOT NULL DEFAULT 0,
