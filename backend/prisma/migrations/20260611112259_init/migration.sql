...
CREATE TABLE "ingredients" (
    ...
    "alt_name" TEXT,
    "category" TEXT,
    "edible_portion" DOUBLE PRECISION NOT NULL DEFAULT 100,
    ...
    "phos" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "iron" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "vit_a" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "thia" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "ribo" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "nia" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "vit_c" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "source" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "stories_post_id_idx" ON "stories"("post_id");
...
-- CreateIndex
CREATE INDEX "ingredients_food_item_idx" ON "ingredients"("food_item");
...
-- AddForeignKey
ALTER TABLE "meal_plans" ADD CONSTRAINT "meal_plans_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
